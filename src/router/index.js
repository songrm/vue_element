...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    [
      ...
      { path: '/permission/car', name: 'car', num_w: '11-2', component: resolve => { require(['../views/permission/car.vue'], resolve) } },
      { path: '/permission/car1', name: 'car1', num_w: '11-3', component: resolve => { require(['../views/permission/car1.vue'], resolve) } }
    ],
