...
export const asyncRouterMap = [
  {
    ...
    children:
    [
      { path: '/icon/index', name: 'icon', num_: '4-1 ', component: resolve => { require(['../views/icon/index.vue'], resolve) } }
...
{ path: '/chart/m_chart', name: 'cross', num_w: '12-2', component: resolve => { require(['../views/chart/m_chart'], resolve) } }
  ...
  },
  {
    ...
    children:
    [
{ path: '/group/article', name: 'article_list', num_w: '10-1', component: resolve => { require(['../views/group/article'], resolve) }, meta: { noCache: true } },
