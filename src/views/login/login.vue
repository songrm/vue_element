		 	...
		 	<el-col :span="24">
		 		...
		 		<el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2"  class="demo-ruleForm">
					...
					<el-form-item label="用户名" prop="usexm">
						<el-input type="text" v-model="ruleForm2.usexm" auto-complete="off"></el-input>
					</el-form-item>
					...
					<el-form-item>
						<el-button type="primary" @click='handleLogin("ruleForm2")' :loading="l_load">提交</el-button>
					</el-form-item>
				</el-form>
...
<style type="text/css">
	.se_wd{width: 30%;margin:100px auto;box-shadow: 0px 1px 10px rgba(0,0,0,0.12);padding: 20px;border-radius: 4px;}
</style>
