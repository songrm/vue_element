<template>
  <div>
    ...
    <tbody>
      <tr v-for="(wh,index) in tableData3" :key='index'>
...
export default {
      ...
      grade: [
        {
          title: '等级1',
          name: 'first',
          content: [{ date: '2017-09-09', gd: '等级1' }]
        },
        {
          title: '等级2',
          name: 'second',
          content: [{ date: '2017-11-09', gd: '等级2' }]
        },
        {
          title: '等级3',
          name: 'third',
          content: [{ date: '2017-12-12', gd: '等级3' }]
        }
      ],
      tab_card: 'first',
      json: '',
  ...
  methods: {
    ...
    toggleSelection(rows) {
      ...
      this.json = rows
      // var rows = [
      //   { date: '2016-05-06', name: '王小虎', address: '123231', __ob__: this }
      // ]
      if (rows) {
        rows.forEach(row => {
          console.log(row)
