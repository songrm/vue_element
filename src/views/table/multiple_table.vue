  ...
  <div>
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input
          size="medium"
          placeholder="请输入搜索条件(区分大小写)"
          v-model="input7"
        ></el-input>
      </el-col>
      <el-col :span="2">
        <el-button plain size="medium" @click="su_ecw()">搜索</el-button>
      </el-col>
      <el-col :span="2">
        <el-button type=""
                   plain
    ...
    <div class="" style="width: 100%; margin-top: 20px;">
      <el-table :data="au_data" border>
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            <el-tag :type="scope.row.state | state_f">
              {{ scope.row.state }}
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="120">
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              size="small"
              @click="handlede(scope.$index, scope.row)"
            >
              删除
            </el-button>
          </template>
    ...
    获取分页：{{ page_num }}
    <page show-item="5" allpage="13" @page-num="get_page"></page>

    <el-dialog :title="dialogStatus" :visible.sync="dialogVisible" width="50%">
      <div class="">
        <el-form :model="form">
          <el-form-item label="作者名称" style="margin-bottom: 0;">
            <el-input v-model="form.author" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="title" style="margin-bottom: 0;">
            <el-input v-model="form.title" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="关注度" style="margin-bottom: 0;">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus == '添加'"
                   type="primary"
                   @click="c_few"
        >确 定</el-button
        >
