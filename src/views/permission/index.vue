      ...
      <el-tabs v-model="activeName">
        ...
        >
          <el-row :gutter="20">
            ...
            >
              <div
                :class="pers_s.department | class_f"
                class="per_all"
              >
                <div class="pes_img">
        ...
        >
          <el-row>
            ...
            <el-col :span="20">
              <div
                class="jq_all"
                style="border-bottom:0px;min-height:300px"
              >
                <p class="jq_name">角色名称</p>
                <el-radio
                  v-model="radio"
...
export default {
  ...
  methods: {
    ...
    resq() {
      ...
      this.$axios.get('/permissionlist').then(res => {
        _self.data_ert = res.data.data
