        ...
        <el-tabs v-model="activeName">
          ...
          <el-tab-pane label="成员管理" name="second">
            <el-row :gutter="20">
              <el-col
                :span="6"
                v-for="pers_s in data_ert"
                class="marbottom20"
                :key="pers_s"
              >
                <div class="per_all" :class="pers_s.department | class_f">
                  <div class="pes_img">
          ...
          <el-tab-pane label="权限分配02" name="five">
            <el-row>
              <el-col :span="20">
                <div class="jq_all" style="border-bottom: 0;">
                  <p class="jq_name">角色名称</p>
                  <el-input
                    placeholder="请输入内容"
                    size="medium"
          ...
          <el-tab-pane label="成员修改设置" name="six">
            <el-row>
              ...
              <el-col :span="20">
                <div
                  class="jq_all"
                  style="border-bottom: 0; min-height: 300px;"
                >
                  <p class="jq_name">角色名称</p>
                  <el-radio v-model="radio" label="1" class="jub">
                    交易部
                  </el-radio>
                  <el-radio v-model="radio" label="2" class="jub">
                    管理员
                  </el-radio>
                </div>
              </el-col>
...
.depart1 {
  border-top: 3px solid #ea6f5a;
}

.depart2 {
  border-top: 3px solid #5cb16a;
}

.depart3 {
  border-top: 3px solid #ffc70a;
}
...
.per_all:hover .per_zpe {
  opacity: 1;
}

.per_all:hover .per_zpe svg {
  margin: 20% 10px;
}
