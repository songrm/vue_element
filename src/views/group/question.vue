    ...
    <el-card class="box-card">
      ...
      <div class="ques_all" v-if="!radio4">
        <template v-for="qd in question_data">
          <div class="a_n_mk" v-for="(qc, index) in qd" :key="index">
            <div class="a_n_mk01">
              <div class="a_n_top">
      ...
      <div class="" v-if="radio4">
        <template v-for="qd in question_data">
          <div class="yl_qu" v-for="(qc, index) in qd" :key="index">
            <p class="yl_ti">{{ index + 1 }}. {{ qc.title }}</p>
            <div class="yl_txt">
              <div class="yl_txt_l" v-for="tix in qc.small" :key="tix">
                {{ tix.small_title }}
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    small(num) {
      // console.log(num)
      this.question_data.question_class[num].small.push({
        small_title: '',
        small_gr: ''
      })
    },
    ...
    sore_table() {
      ...
      //     $('.ques_all .a_n_mk .a_n_mk01 .a_n_m')[i]
      //   )
