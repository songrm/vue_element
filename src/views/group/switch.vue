<template>
  <div class="">
    <el-card class="box-card">
      ...
      <div class="">
        <el-alert title="switch开关 表示两种相互对立的状态间的切换，多用于触发「开/关」。" type="success" class="martop20"></el-alert>
        <el-row class="martop20">
          <el-col :span='8'>
              <div class="anniu">
                <el-switch v-model="value1"  active-color="#13ce66"  inactive-color="#999"></el-switch>
              </div>
              <div class="anniu">
              ...
              <div class="anniu">
                ...
                <el-switch v-model="value3"  active-color="#13ce66"  inactive-color="#ff4949"  disabled></el-switch>
              </div>
          </el-col>
        </el-row>
        <el-alert title="Radio 单选框 在一组备选项中进行单选" type="success" class="martop20"></el-alert>
        ...
        <el-alert title="Checkbox 一组备选项中进行多选" type="success" class="martop20" style="margin-top:20px;"></el-alert>
        <el-row class="martop20" :gutter="20">
          <el-col :span='8'>
              <div class="">
        ...
        <el-alert title="Pagination 分页" type="success" class="martop20" style="margin-top:20px;"></el-alert>
        <el-row class="martop20" :gutter="20">
          <el-col :span='12'>
              <div class="">
                <div class="block">
