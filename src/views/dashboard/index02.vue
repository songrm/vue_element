      ...
      <el-col :span="7">
        <el-card class="box-card" :body-style="{ padding: '0px' }">
          ...
          <div class="person_jies_all">
            <div class="person_jies" v-for="(o, index) in 8" :key="index">
      ...
      <el-col :span="24" class="prm_zer">
        <el-card class="box-card" :body-style="{ padding: '0px' }">
          ...
          <el-table
            ...
            style="width: 99%;"
          >
            <el-table-column prop="id" label="模块分类" width="180">
            </el-table-column>
            <el-table-column prop="name" label="自模块">
            ...
            <el-table-column prop="amount1" label="功能描述"> </el-table-column>
          </el-table>
        </el-card>
      </el-col>
    </el-row>
    <el-dialog title="提示" width="38%" :visible.sync="dialogVisible">
      <div class="">
        <el-date-picker
          v-model="tck_time"
          type="date"
